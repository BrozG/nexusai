  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const cameraPositions = [
        { x: 0, y: 30, z: 100 },   // Section 0 - ABYSS
        { x: 0, y: 40, z: -50 },   // Section 1 - ORBIT
        { x: 0, y: 50, z: -500 },  // Section 2 - IGNITE
        { x: 0, y: 50, z: -800 },  // Section 3 - NEXUS AI 
      ];
  ...
  return (
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div ref={menuRef} className="side-menu" style={{ visibility: 'hidden' }}>
        <div
          ...
          style={{
            ...
            padding: '8px',
            borderRadius: '8px',
            border: menuOpen ? '1px solid #ff3333' : '1px solid transparent',
            transition: 'all 0.2s ease',
          }}
        >
          <span style={{ background: menuOpen ? '#ff3333' : 'rgba(255,255,255,0.5)' }}></span>
          <span style={{ background: menuOpen ? '#ff3333' : 'rgba(255,255,255,0.5)' }}></span>
          <span style={{ background: menuOpen ? '#ff3333' : 'rgba(255,255,255,0.5)' }}></span>
        </div>
        ...
        {menuOpen && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '12px' }}>
            <button
              ...
              onMouseEnter={e => { e.currentTarget.style.background = '#ff3333'; e.currentTarget.style.color = 'white'; }}
      ...
      <div className="scroll-sections">
        ...
        {/* ABYSS — scrolls like all others */}
        <section className="content-section">
          <h1 ref={titleRef} className="hero-title">ABYSS</h1>
          <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
            <p className="subtitle-line">DEPTH OF UNDERSTANDING, NO LIMITS</p>
          </div>
        </section>
        ...
        <section className="content-section">
          ...
          <div className="hero-subtitle cosmos-subtitle">
            <p className="subtitle-line">CIRCLING EVERY DOMAIN WITH PRECISION</p>
          </div>
        </section>
        ...
        <section className="content-section">
          ...
          <div className="hero-subtitle cosmos-subtitle">
            <p className="subtitle-line">INTELLIGENCE THAT SPARKS THE ANSWER</p>
          </div>
        </section>
        ...
        <section className="content-section">
          <div ref={ctaRef} style={{ textAlign: 'center' }}>
            <h1 className="hero-title" style={{ visibility: 'visible' }}>NEXUS AI</h1>
            <p className="subtitle-line" style={{
              marginBottom: '48px',
              display: 'block',
              color: '#ff3b3b',
              textShadow: '0 0 20px rgba(0,0,0,0.8), 0 2px 8px rgba(0,0,0,1)'
            }}>
              SCALABLE CUSTOMER SUPPORT · LORA FINE-TUNED INTELLIGENCE
            </p>

            <div style={{ display: 'flex', gap: '10px', justifyContent: 'center', flexWrap: 'wrap' }}>
              {['built to listen', 'trained to think', 'made to answer', 'born to scale'].map(t => (
                <span key={t} className="pill-tag" style={{ 
                  fontFamily: "'DM Mono', monospace", fontSize: '10px',
                  color: '#ff3b3b', border: '1px solid rgba(255,59,59,0.4)',
